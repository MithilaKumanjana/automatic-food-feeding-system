...
const char* ssid = "SAMSUNG J2" ;            //Add your WiFi ssid
const char* password =  "Taboo@123" ;   //Add your WiFi password

String apiKey = "2058593";              //Add your Token number that bot has sent you on WhatsApp messenger
String phone_number = "+94764627205"; //Add your WhatsApp app registered phone number (same number that bot send you in url)
...
void setup() 
{
  ...
  message_to_whatsapp("Refill the food .");  // you send your own message just change "hello from TechTOnions" to your message.
}
